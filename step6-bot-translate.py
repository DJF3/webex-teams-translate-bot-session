...
# tokens below: you could replace 'os.environ.etc.' with the actual tokens.
...
def webhook():
    ...
    if message.personEmail == "your_bot_email@webex.bot":
        ...
        if my_language in ('nl', 'de', 'en', 'fr', 'es'):
            ...
            api.messages.create(toPersonId=message.personId, markdown="please start your message with the language code: nl de en fr es  followed by the text to translate")
